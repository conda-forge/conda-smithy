...
For example, you should be able to `conda smithy register-create` without the CI service tokens.
...
2. **Create a github repo:** `conda smithy register-create --organization conda-forge ./foo-feedstock`.
