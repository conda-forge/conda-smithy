...
`conda-smithy`. The commands which need this will tell you where to get these tokesn and where to
...
directory called `foo-feedstock`, populates it with CI setup skeletons, adds teh recipe under
