...
def lintify(meta, recipe_dir=None, conda_forge=False):
    ...
    if build_reqs and ("numpy x.x" in build_reqs):
        lints.append(
            ...
            "[here](https://conda-forge.readthedocs.io/en/latest/docs/meta.html#building-against-numpy)."
        )
    ...
    if build_reqs and ("toolchain" in build_reqs):
        lints.append(
            ...
            "[here](https://conda-forge.readthedocs.io/en/latest/docs/meta.html#compilers)."
        )
        ...
        for script in scripts:
            if "python setup.py install" in script:
                hints.append(
                    ...
                    "See https://conda-forge.readthedocs.io/en/latest/docs/meta.html#use-pip"
                )
        ...
        with io.open(meta_fname, "rt") as fh:
            ...
            if no_arch_possible:
                hints.append(
                    ...
                    "See https://conda-forge.readthedocs.io/en/latest/docs/meta.html#building-noarch-packages"
                )
