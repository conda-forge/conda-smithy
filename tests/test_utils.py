...
def test_get_metadata_from_feedstock_dir(noarch_recipe):
    ...
    expected_metadata_type = RatlerBuildMetadata if build_tool == RATTLER_BUILD else MetaData
...
def test_get_metadata_from_feedstock_dir_jinja2(noarch_recipe_with_python_min):
    ...
    metadata = _get_metadata_from_feedstock_dir(
        ...
        conda_forge_pinning_file=noarch_recipe_with_python_min[1]["exclusive_config_file"],
    )
...
def test_get_feedstock_name_from_rattler_metadata(
    ...
    metadata = _get_metadata_from_feedstock_dir(feedstock_dir, v1_noarch_recipe_with_context[1])
...
def test_get_feedstock_name_from_rattler_metadata_multiple_outputs(
    ...
    metadata = _get_metadata_from_feedstock_dir(feedstock_dir, v1_recipe_with_multiple_outputs[1])
